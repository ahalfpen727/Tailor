...
#--BOWTIE2-BUILD-----------------------------------------
# bowtie2-build 
# This command produces a bowtie2index genome index from a genome fasta file
...
COMMAND_LINE="${COMMAND} ${EXTRA_BOWTIE_BUILD_PARAMETERS} ${BOWTIE_INPUT} ${BOWTIE_OUTPUT}"
